<script lang="ts">
  ...
  $: langkahList = rumah.langkah && rumah.langkah.length > 0 ? rumah.langkah : [
    {
      urutan: 1,
  ...
  function handleImgError(event: Event) {
    ...
    target.src = "https://images.unsplash.com/photo-1590740608753-ff827f333671?w=800&auto=format&fit=crop&q=80";
  }
</script>
...
<div class="nav-screen">
  ...
  <header class="header">
    ...
    <button type="button" class="exit-btn" on:click={onExit} title="Keluar / Ganti Rute" aria-label="Keluar / Ganti Rute">
      ✕
    </button>
  </header>
  ...
  <div class="progress-bar-container" aria-label={`Progress langkah ${currentStep + 1} dari ${totalSteps}`}>
